...
static esp_err_t rc522_create_transport(rc522_handle_t rc522)
{
    ...
    case RC522_TRANSPORT_I2C:
    {
        ...
        i2c_master_bus_config_t i2c_mst_config = {
            .clk_source = I2C_CLK_SRC_DEFAULT,
            .i2c_port = -1,
            .scl_io_num = rc522->config->i2c.sda_gpio,
            .sda_io_num = rc522->config->i2c.scl_gpio,
            .glitch_ignore_cnt = 7,
            .flags.enable_internal_pullup = true,
        };

        
        ESP_ERR_RET_GUARD(i2c_new_master_bus(&i2c_mst_config, &rc522->bus_handle));

        i2c_device_config_t dev_cfg = {
            .dev_addr_length = I2C_ADDR_BIT_LEN_7,
            .device_address =  RC522_I2C_ADDRESS,
            .scl_speed_hz = rc522->config->i2c.clock_speed_hz,
        };

        
        ESP_ERR_RET_GUARD(i2c_master_bus_add_device(rc522->bus_handle, &dev_cfg, &rc522->dev_handle));
    }
...
static esp_err_t rc522_destroy_transport(rc522_handle_t rc522)
{
    ...
    case RC522_TRANSPORT_SPI:
        ...
        break;
    case RC522_TRANSPORT_I2C:
        err = i2c_master_bus_rm_device(rc522->dev_handle);
        break;
    default:
